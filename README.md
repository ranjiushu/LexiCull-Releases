...
> LexiCull 另有 Web 版（单文件产物，开发者自用），本仓库只分发 Android 版。

## 这是什么

打造易用可靠的**个人辞书应用**。不止于背单词 —— 收录、整理、比对、回顾你的专属词库。
...
Obsidian 搞的长文档知识库压根没人读也没人写，检索复杂麻烦，拿给 Agent 吞了吐、吐了吞，次数越多，精度损失越多。

别的词典都是给定的词，考学占的是主流，压根满足不了个人聚焦某个专门领域的辞书使用需求。只要是相对严肃的学习，就离不开辞书。用 Excel 之类的工具管理这些知识丝毫没有便利性可言，之前这一类的需求一直都是笔记软件在代劳。

艾宾浩斯搞的记忆研究，针对的是没有意义的内容，套用到知识学习上噱头大于科学；讲科学，它的作用可能就只是哄着你学习了。LexiCull 不搞记忆曲线：某些知识你看完、筛查完，感觉差不多就得了，下次遇到再筛再记的意义，远大于哄着你每天看十几个名词。
